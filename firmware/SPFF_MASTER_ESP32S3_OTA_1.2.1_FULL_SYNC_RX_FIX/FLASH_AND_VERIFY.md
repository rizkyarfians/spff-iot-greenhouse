# SPFF ESP32-S3 firmware 1.2.1 full sync RX fix
...
- RX queue USB CDC diperbesar dari default 256 byte menjadi 16 KiB sebelum Serial.begin(), sehingga command dan snapshot schedule tidak terpotong.
