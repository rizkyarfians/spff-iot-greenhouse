# SPFF ESP32-S3 firmware 1.3.0 automatic control
...
yang terkalibrasi. Karena itu `minTankLevelPercent` harus dibiarkan kosong.
Validasi level tangki baru boleh diaktifkan setelah mapping jarak-ke-persen
disepakati dan ditambahkan ke telemetry firmware.
